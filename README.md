...
If you don't have it installed, I recommend installing Java 25. 
...
You should see output indicating Java 25 (or 21+).

Alternatively, on macOS and Linux you can use [SDKMAN](https://sdkman.io/) which handles PATH configuration automatically.
